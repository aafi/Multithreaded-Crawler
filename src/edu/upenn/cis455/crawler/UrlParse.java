...
public class UrlParse {
	 ...
	 */
	public UrlParse(String docURL){
		if(docURL == null || docURL.equals(""))
			return;
		docURL = docURL.trim();
		if(!docURL.startsWith("https://") || docURL.length() < 8)
			return;
		// Stripping off 'http://'
	...
	public UrlParse(String hostName, String filePath){
		this.hostName = hostName;
		this.filePath = filePath;
		this.portNo = 80;
	}
	
	public UrlParse(String hostName,int portNo,String filePath){
		this.hostName = hostName;
		this.portNo = portNo;
		this.filePath = filePath;
	}
